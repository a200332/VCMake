...
tie %Config, 'Config', {
    archlibexp => 'F:\Green\Language\Perl\\lib',
    ...
    osvers => '6.1',
    path_sep => ';',
    privlibexp => 'F:\Green\Language\Perl\\lib',
    scriptdir => 'F:\Green\Language\Perl\\bin',
    sitearchexp => 'F:\Green\Language\Perl\\site\\lib',
    sitelibexp => 'F:\Green\Language\Perl\\site\\lib',
    so => 'dll',
    useithreads => 'define',
